package com.ariel.jdbc.day02.stmt.member.model.vo;
...
public class Member {
	...
	public Member(String memberId, String memberPwd, String memberName, String email, String address, String hobby) {
		super();
		this.memberId = memberId;
		this.memberPwd = memberPwd;
		this.memberName = memberName;
